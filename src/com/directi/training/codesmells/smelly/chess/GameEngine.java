...
/**
 * @author Anna Lea Rocher
 * @see <a href="http://github.com/annalr99/introPRG23.git">...</a>
 */
...
public class GameEngine
{
    ...
    /**
     * Torna a inicialitzar el taulell.
     *
     * Aquest mètode permet tornar a tornar a inicialitzar
     * el taulell d'escacs
     *
     */
    ...
    /**
     * Realitzar un moviment
     *
     * Aquest mètode, passar un moviment, mou les peces del escac.
     *
     * @param move el moviment de la peça. S'ha de passar un objecte de tipus Move.
     *
     */
     ...
     *
     * Aquest mètode, passar¡t un moviment, verifica si pot o no fer-se.
     *
     * @param move el moviment de la peça. S'ha de passar un objecte de tipus Move.
     * @return a boolean. Si es pot fer retorna true i si no, retorna false
     *
     */
